...
NAV = [("/", "Home"), ("/about/", "About"), ("/donate/", "Donate")]   # Apply lives in the CTA button
...
def header(active):
    ...
    <nav class="nav" aria-label="Main">{links}
      <a class="btn btn--solid" href="/apply/"{' aria-current="page"' if active == "/apply/" else ''}>Apply for help</a>
    </nav>
...
<footer class="ftr">
  <div class="wrap">
    <div class="ftr-grid">
      ...
      {col("Fund", [("/", "Home"), ("/about/", "About us"), ("/about/#how", "How it works"), ("/about/#video", "Watch the video")])}
